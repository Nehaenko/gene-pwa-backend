define([
    ...
    /**
     * Bind events to add empty History Item
     */
    Preview.prototype.bindEvents = function bindEvents() {
        ...
        events.on("history:dropAfter", function (args) {
     ...
     * Add History Item
     */
    Preview.prototype.addHistoryItem = function () {
        var self = this;
        createContentType(
            pageBuilderConfig.getContentTypeConfig("history-item"),
            this.contentType,
